...
TEST_SUITE(FF_TEST_SUITE) {
  TEST_CASE("Test BatchNorm Kernel") {
    ...
    BatchNormPerDeviceState state =
        Kernels::BatchNorm::init_kernel(/*handle=*/managed_handle.raw_handle(),
                                        /*allocator=*/allocator,
                                        /*runningMean=*/nullptr,
    ...
    SUBCASE("forward_kernel") {
      ...
      Kernels::BatchNorm::forward_kernel(/*stream=*/managed_stream.raw_stream(),
    ...
    SUBCASE("backward_kernel") {
      ...
      Kernels::BatchNorm::backward_kernel(/*stream=*/managed_stream.raw_stream(),
                                          /*per_device_state=*/state,
                                          /*input_ptr=*/input_accessor.get_float_ptr(),
                                          ...
                                          /*numElements=*/input_accessor.shape.num_elements().unwrap_nonnegative());
