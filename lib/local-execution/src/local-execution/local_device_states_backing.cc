...
//     std::unordered_map<layer_guid_t, SymbolicLayerTrainingTensorGroupSignatureWithShapes> const &layers,
//     std::unordered_map<layer_guid_t, ComputationGraphOpAttrs> const &op_attrs,
//     RuntimeArgConfig const &runtime_arg_config,
//     LocalTensorBacking const &local_tensor_backing,
//     Allocator &allocator) {
//
//   std::unordered_map<layer_guid_t, std::optional<DeviceSpecificPerDeviceOpState>>
//       per_device_op_states = generate_map(
//           keys(layers),
//           [&](layer_guid_t const &layer_guid) -> std::optional<DeviceSpecificPerDeviceOpState> {
...
// std::optional<DeviceSpecificPerDeviceOpState> get_per_device_op_state_if_exists(
