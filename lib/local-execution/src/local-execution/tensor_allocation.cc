...
bool no_tensors_are_allocated(DynamicOpenDataflowGraph const &g) {
  return all_are_true(
    transform(get_dynamic_values(g),
...
DynamicOpenDataflowGraph
  perform_tensor_allocation(DynamicOpenDataflowGraph const &g, 
                            ...
                            Allocator &allocator) 
{
  ...
  bidict<DynamicValueAttrs, DynamicValueAttrs>
    unallocated_to_allocated = 
