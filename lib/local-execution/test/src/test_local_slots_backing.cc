    ...
    SUBCASE("LocalSlotsBacking::allocate_outgoing_tensors") {
      ...
      SUBCASE("Input (QKV) and gradient tensors allocation") {
        ...
        SUBCASE("Query grad") {
          ...
          std::pair<ArrayShape, DataType> correct = {array_shape_from_tensor_shape(query_shape),
                                                     dtype};
        ...
        SUBCASE("Key grad") {
          ...
          std::pair<ArrayShape, DataType> correct = {array_shape_from_tensor_shape(key_shape),
                                                     dtype};
          CHECK(result == correct);
        }
        SUBCASE("Value grad") {
          ...
          std::pair<ArrayShape, DataType> correct = {array_shape_from_tensor_shape(value_shape),
                                                     dtype};
          CHECK(result == correct);
        }
      }
