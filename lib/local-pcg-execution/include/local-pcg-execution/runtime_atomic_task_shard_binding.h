...
RuntimeAtomicTaskShardBinding
  lower_op_shard_binding_to_fwd_pass_runtime_shard_binding(OperatorAtomicTaskShardBinding const &,
                                                           SymbolicLayerTrainingTensorGroupSignature const &);

RuntimeAtomicTaskShardBinding 
  lower_op_shard_binding_to_bwd_pass_runtime_shard_binding(OperatorAtomicTaskShardBinding const &,
                                                           SymbolicLayerTrainingTensorGroupSignature const &);

RuntimeAtomicTaskShardBinding 
  lower_op_shard_binding_to_runtime_shard_binding(OperatorAtomicTaskShardBinding const &,
                                                  SymbolicLayerTrainingTensorGroupSignature const &,
                                                  FwbOpTaskType);
