...
bool MappedPerDeviceOpStatesGroup::operator==(
    MappedPerDeviceOpStatesGroup const &other) const {
...
std::string format_as(::FlexFlow::MappedPerDeviceOpStatesGroup const &m) {
  return fmt::format("<MappedPerDeviceOpStatesGroup shard_bindings={}>",
                     m.get_shard_bindings());
}

std::ostream &operator<<(std::ostream &s,
                         ::FlexFlow::MappedPerDeviceOpStatesGroup const &x) {
  return (s << fmt::to_string(x));
}

MappedPerDeviceOpStatesGroup mapped_operator_task_group_from_machine_view(
...
size_t hash<::FlexFlow::MappedPerDeviceOpStatesGroup>::operator()(
    ::FlexFlow::MappedPerDeviceOpStatesGroup const &x) const {
