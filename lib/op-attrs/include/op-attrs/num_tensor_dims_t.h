...
num_tensor_dims_t
    num_tensor_dims_from_num_ptensor_parallel_dims(num_ptensor_parallel_dims_t);

num_ptensor_shard_dims_t
    num_ptensor_shard_dims_from_num_tensor_dims(num_tensor_dims_t);

num_ptensor_parallel_dims_t
    num_ptensor_parallel_dims_from_num_tensor_dims(num_tensor_dims_t);
