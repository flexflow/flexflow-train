...
tensor_guid_t ComputationGraphBuilder::gather(
  ...
  GatherAttrs attrs = GatherAttrs{ff_dim_t_from_relative_ff_dim_t_ff_dim_t(
      dim, num_dims(this->get_shape(input)))};
  std::string name =
      maybe_name.value_or(get_default_name(ComputationGraphOpAttrs{attrs}));
...
tensor_guid_t ComputationGraphBuilder::concat(
  ...
  ConcatAttrs attrs = ConcatAttrs{ff_dim_t_from_relative_ff_dim_t_ff_dim_t(
...
tensor_guid_t ComputationGraphBuilder::flat(
  ...
  FlatAttrs attrs = FlatAttrs{
      /*start_dim=*/ff_dim_t_from_relative_ff_dim_t_ff_dim_t(
