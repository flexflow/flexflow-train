...
MachineSpaceOffset get_machine_space_offset_from_coordinate(
  ...
  return MachineSpaceOffset{
    /*node_offset=*/coord.node_idx.unwrap_nonnegative() - start.node_idx.unwrap_nonnegative(),
    /*device_offset=*/coord.device_idx.unwrap_nonnegative() - start.device_idx.unwrap_nonnegative(),
