...
TEST_SUITE(FF_TEST_SUITE) {
  TEST_CASE("pcg_from_computation_graph") {
    ...
    ComputationGraph cg = [&] {
      ...
      tensor_guid_t t_linear = require_only_key(linear_added.outputs, TensorSlotName::OUTPUT);
    ...
    ParallelComputationGraph correct = [&] {
      ...
      parallel_tensor_guid_t t_linear = require_only_key(linear_added.outputs, TensorSlotName::OUTPUT);
