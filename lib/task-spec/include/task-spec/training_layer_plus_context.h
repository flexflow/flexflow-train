...
std::vector<TensorShape> get_weight_tensor_shapes(TrainingLayerPlusContext const &);
...
std::vector<TensorShape> get_output_tensor_shapes(TrainingLayerPlusContext const &);

TrainingLayerTensorGroupSignature get_tensor_group_signature(TrainingLayerPlusContext const &);
CGOperatorTensorShapeSignature get_cg_op_shape_signature(TrainingLayerPlusContext const &);
