...
task_id_with_noop_default_t
  ...
  return op_attrs.visit<task_id_with_noop_default_t>(overload {
    ...
    [](ElementBinaryAttrs const &) { return task_id_t::ELEMENTBINARY_INIT_TASK_ID; },
    [](ElementUnaryAttrs const &) { return task_id_t::ELEMENTBINARY_INIT_TASK_ID; },
    [](EmbeddingAttrs const &) { return default_noop_task(); },
    [](FlatAttrs const &) { return task_id_t::FLAT_INIT_TASK_ID; },
    ...
    [](MultiHeadAttentionAttrs const &) { return task_id_t::ATTENTION_INIT_TASK_ID; },
...
task_id_with_noop_default_t
  ...
  return op_attrs.visit<task_id_with_noop_default_t>(overload {
    [](BatchMatmulAttrs const &) { return task_id_t::BATCHMATMUL_FWD_TASK_ID; },
    ...
    [](ElementBinaryAttrs const &) { return task_id_t::ELEMENTBINARY_FWD_TASK_ID; },
    [](ElementUnaryAttrs const &) { return task_id_t::ELEMENTBINARY_FWD_TASK_ID; },
    ...
    [](MultiHeadAttentionAttrs const &) { return task_id_t::ATTENTION_FWD_TASK_ID; },
...
task_id_with_noop_default_t
  ...
  return op_attrs.visit<task_id_with_noop_default_t>(overload {
    [](BatchMatmulAttrs const &) { return task_id_t::BATCHMATMUL_BWD_TASK_ID; },
    ...
    [](ElementBinaryAttrs const &) { return task_id_t::ELEMENTBINARY_BWD_TASK_ID; },
    [](ElementUnaryAttrs const &) { return task_id_t::ELEMENTBINARY_BWD_TASK_ID; },
    ...
    [](MultiHeadAttentionAttrs const &) { return task_id_t::ATTENTION_BWD_TASK_ID; },
