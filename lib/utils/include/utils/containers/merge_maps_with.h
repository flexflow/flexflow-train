...
std::unordered_map<K, V> merge_maps_with(std::vector<std::unordered_map<K, V>> const &to_merge, F &&f) {
  return foldl(to_merge, 
               std::unordered_map<K, V>{}, 
               [&](std::unordered_map<K, V> const &accum, std::unordered_map<K, V> const &m) {
