...
LabelledOpenKwargDataflowGraphView<NodeLabel, ValueLabel, GraphInputName, SlotName> 
  ...
  OpenKwargDataflowGraphView<GraphInputName, SlotName> permuted = permute_open_kwarg_dataflow_graph_node_ids(
      static_cast<OpenKwargDataflowGraphView<GraphInputName, SlotName>>(g), new_node_tofrom_old_node);
