...
bidict<OpenKwargDataflowValue<GraphInputName, SlotName>, KwargDataflowGraphInput<GraphInputName>>
  ...
  return generate_bidict(get_open_kwarg_dataflow_subgraph_inputs(g, subgraph_nodes),
                         [&](OpenKwargDataflowValue<GraphInputName, SlotName> const &v) 
                           -> KwargDataflowGraphInput<GraphInputName>
                         {
                           return v.template visit<KwargDataflowGraphInput<GraphInputName>>(overload{
                               [](KwargDataflowGraphInput<GraphInputName> const &i) { return i; },
...
{
  std::unordered_set<OpenKwargDataflowEdge<GraphInputName, SlotName>> subgraph_input_edges =
      transform(get_open_kwarg_dataflow_subgraph_incoming_edges(g, subgraph_nodes),
                [&](OpenKwargDataflowEdge<GraphInputName, SlotName> const &edge) {
                  return edge.template visit<OpenKwargDataflowEdge<GraphInputName, SlotName>>(
                      overload{
                          ...
                          return OpenKwargDataflowEdge<GraphInputName, SlotName>{
                            KwargDataflowInputEdge<GraphInputName, SlotName>{
                              full_graph_values_to_subgraph_inputs.at_l(
                                OpenKwargDataflowValue<GraphInputName, SlotName>{e.src}),
                              e.dst
                            },
                          };
                        },
  ...
  OpenKwargDataflowEdgeQuery<GraphInputName, SlotName> subgraph_interior_edges_query 
  ...
  std::unordered_set<OpenKwargDataflowEdge<GraphInputName, SlotName>> subgraph_interior_edges =
