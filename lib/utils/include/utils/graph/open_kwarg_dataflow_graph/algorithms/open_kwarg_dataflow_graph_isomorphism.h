...
{
  return l_value.template visit<OpenKwargDataflowValue<GraphInputName, SlotName>>(overload{
      ...
      [&](KwargDataflowOutput<SlotName> const &l_output) {
        return OpenKwargDataflowValue<GraphInputName, SlotName>{
            isomorphism_map_r_kwarg_dataflow_output_from_l(iso, l_output),
        };
      },
  });
}
...
{
  return r_value.template visit<OpenKwargDataflowValue<GraphInputName, SlotName>>(overload{
      ...
      [&](KwargDataflowOutput<SlotName> const &r_output) {
        return OpenKwargDataflowValue<GraphInputName, SlotName>{
            isomorphism_map_l_kwarg_dataflow_output_from_r(iso, r_output),
        };
      },
  });
