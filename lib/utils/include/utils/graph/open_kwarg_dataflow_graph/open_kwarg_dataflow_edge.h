...
OpenKwargDataflowEdge<GraphInputName, SlotName>
  ...
  return src.template visit<OpenKwargDataflowEdge<GraphInputName, SlotName>>(
      overload{[&](KwargDataflowOutput<SlotName> const &output) {
...
OpenKwargDataflowValue<GraphInputName, SlotName>
  ...
  return e.template visit<OpenKwargDataflowValue<GraphInputName, SlotName>>(
      overload{[](KwargDataflowInputEdge<GraphInputName, SlotName> const
                      &external_edge) {
...
template <typename GraphInputName, typename SlotName>
KwargDataflowInput<SlotName> get_dst_of_open_kwarg_dataflow_edge(
    OpenKwargDataflowEdge<GraphInputName, SlotName> const &e) {
  return e.template visit<KwargDataflowInput<SlotName>>(
      overload{[](KwargDataflowInputEdge<GraphInputName, SlotName> const
                      &external_edge) { return external_edge.dst; },
               [](KwargDataflowEdge<SlotName> const &internal_edge) {
