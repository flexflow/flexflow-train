  ...
  TEST_CASE("is_valid_sp_ization") {
    ...
    SUBCASE("SerialSplit") {
      ...
      SUBCASE("Incorrect SP-ization") {
        ...
        CHECK_FALSE(is_valid_sp_ization(g, sp));
      }
    }
    ...
    SUBCASE("Rhombus") {
      ...
      SUBCASE("Valid SP-izations") {
        ...
        CHECK(is_valid_sp_ization(g, sp_correct));
      ...
      SUBCASE("Invalid SP-ization") {
        ...
        CHECK_FALSE(is_valid_sp_ization(g, sp_incorrect));
      }
    }
      ...
      SUBCASE("Invalid SP-izations") {
        SerialParallelDecomposition sp_correct = SerialParallelDecomposition{
            SerialSplit{{n.at(0),
                         ...
                         n.at(3),
                         n.at(5)}}};
        CHECK_FALSE(is_valid_sp_ization(g, sp_correct));
      }
    }
  }
}
