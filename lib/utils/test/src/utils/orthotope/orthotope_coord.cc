...
TEST_SUITE(FF_TEST_SUITE) {
  TEST_CASE("restrict_orthotope_coord_to_dims") {
    ...
    SUBCASE("allowed_dims is a superset of the coord's dims") {
      ...
      OrthotopeCoord result = restrict_orthotope_coord_to_dims(coord, allowed_dims);
    ...
    SUBCASE("coord is empty") {
      ...
      OrthotopeCoord result = restrict_orthotope_coord_to_dims(
        OrthotopeCoord{{}}, allowed_dims);
